...
class BmiWeeklyGoalWeightPage extends StatefulWidget {
  ...
  @override
  State<BmiWeeklyGoalWeightPage> createState() => _BmiWeeklyGoalWeightPageState();
}

class _BmiWeeklyGoalWeightPageState extends State<BmiWeeklyGoalWeightPage> {
