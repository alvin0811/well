...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String userName, String userEmail, String userImage, bool isDeleted});
}
...
class _$SettingStateImpl extends _SettingState {
  const _$SettingStateImpl(
      ...
      this.userEmail = emptyString,
      this.userImage = emptyString,
  ...
  @override
  String toString() {
    return 'SettingState(userName: $userName, userEmail: $userEmail, userImage: $userImage, isDeleted: $isDeleted)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userName, userEmail, userImage, isDeleted);
...
abstract class _SettingState extends SettingState {
  const factory _SettingState(
      ...
      final String userEmail,
      final String userImage,
      final bool isDeleted}) = _$SettingStateImpl;
