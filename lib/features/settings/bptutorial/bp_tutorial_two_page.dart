...
class BpTutorialTwoSettingPage extends StatefulWidget {
  const BpTutorialTwoSettingPage({super.key});

  @override
  State<BpTutorialTwoSettingPage> createState() =>
      _BpTutorialTwoSettingPageState();
}

class _BpTutorialTwoSettingPageState extends State<BpTutorialTwoSettingPage> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SvgPicture.asset(
                    "assets/images/ic_bptutorial_two.svg",
                  ...
                  Padding(
                    ...
                    child: WellPathButton(
                        onPressed: () {
                          Navigator.of(context).pushNamed("/bptutorialthree");
                        },
                        buttonText: "Next"),
                  ),
                  const SizedBox(
